...
License: GPLv2
*/
define( 'ADDRESS_PLUGIN_PATH', plugins_url( 'images/address.png', __FILE__ ) );
define( 'FAX_PLUGIN_PATH', plugins_url( 'images/fax.png', __FILE__ ) );
define( 'PHONE_PLUGIN_PATH', plugins_url( 'images/phone.png', __FILE__ ) );
define( 'EMAIL_PLUGIN_PATH', plugins_url( 'images/email.png', __FILE__ ) );

class scw_widget extends WP_Widget {

	function __construct() {
	parent::__construct('scw_widget', __('Contact Info Widget', 'scw_widget_domain'), 

	array( 'description' => __( 'This widget is used to display contact information with map.', 'scw_widget_domain' ), ) );
}
...
<div id="map-canvas"></div>
	...
	google.maps.event.addDomListener( window, 'load', scw_gmaps_results_initialize );
	function scw_gmaps_results_initialize() {
...
<div class="address"><span><img src="<?php echo ADDRESS_PLUGIN_PATH; ?>"></span> <?php echo $instance['address']; ?></div>
<?php endif;?>

<?php if($instance['fax']): ?>
<div class="fax"><span><img src="<?php echo FAX_PLUGIN_PATH; ?>"></span> <?php echo $instance['fax']; ?></div>
<?php endif;?>
...
$title = __( 'Contact Info', 'scw_widget_domain' );
} ?>
<p>
